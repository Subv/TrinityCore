...
const char CreatureModelDatafmt[]="nxxxfxxxxxxxxxxffxxxxxxxxxxx"; // todo
const char CreatureSpellDatafmt[]="niiiixxxx"; // done
const char CreatureTypefmt[]="nxx"; // done
const char CurrencyTypesfmt[]="nxxxxxxiixx"; // done
const char DestructibleModelDatafmt[]="nxxixxxixxxixxxixxx"; // done
...
const char GtOCTBaseHPByClassfmt[]="xf"; // TODO
const char GtOCTBaseMPByClassfmt[]="xf"; // TODO
...
const char ScalingStatValuesfmt[]="iniiiiiiiiiiiiiiiiiiiixxxxxxxxxxxxxxxxxxxxxxxxx"; // done
...
const char SpellShapeshiftfmt[]="nxxiixiiixxiiiiiiiixx"; // done
