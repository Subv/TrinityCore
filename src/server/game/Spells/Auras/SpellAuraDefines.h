...
enum AuraType
{
    ...
    SPELL_AURA_MOD_SPELL_POWER_PCT = 317, // NYI
    SPELL_AURA_MASTERY = 318,  // NYI
    SPELL_AURA_319 = 319, // (melee?) attack speed  NYI
    SPELL_AURA_MOD_RANGED_ATTACK_SPEED = 320, // NYI
    SPELL_AURA_321 = 321,  // NYI
    SPELL_AURA_INTERFERE_TARGETTING = 322, // NYI
    SPELL_AURA_323 = 323,  // NYI
    SPELL_AURA_324 = 324, // spell critical chance (probably by school mask)  NYI
    SPELL_AURA_325 = 325,  // NYI
    SPELL_AURA_326 = 326, // phase related  NYI
    SPELL_AURA_327 = 327,  // NYI
    SPELL_AURA_328 = 328,  // NYI
    SPELL_AURA_MOD_RUNE_REGEN_SPEED = 329, // NYI
    SPELL_AURA_CAST_WHILE_WALKING = 330, // NYI
    SPELL_AURA_331 = 331,  // NYI
    ...
    SPELL_AURA_340 = 340,  // NYI
    SPELL_AURA_341 = 341, // cooldown decrease  NYI
    SPELL_AURA_MOD_TIME_BETWEEN_ATTACKS = 342, // (attack speed) NYI
    SPELL_AURA_343 = 343,  // NYI
    SPELL_AURA_MOD_AUTOATTACK_DAMAGE = 344,  // NYI
    SPELL_AURA_BYPASS_ARMOR_FOR_CASTER = 345,  // NYI
